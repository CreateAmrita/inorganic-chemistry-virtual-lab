...
var alkalinity_value,
	selected_water_type,
	selected_normality,
	selected_cod_normality,
	selected_molarity,
	water_sample_index;
	...
	return {
		...
		link: function(scope, element, attrs, dialogs) {
			...
			function handleComplete() {
				...
				loadImages(
					queue.getResult('burette_solution'),
					'burette_solution',
					335,
					70,
					'',
				...
				for (var i = 1; i <= 7; i++) {
					loadImages(
						queue.getResult('conical_flask_solution' + i),
						'conical_flask_solution' + i,
						305,
						425,
						'',
						0,
				...
				loadImages(
					queue.getResult('cod_conical_flask'),
					'cod_conical_flask',
					303,
					459,
					'',
			...
			function translationLabels() {
				...
				/** Error message */
				scope.error_message = _(
					'Please select Phenolphthaline indicator first, followed by Methyl Orange indicator'
				);
